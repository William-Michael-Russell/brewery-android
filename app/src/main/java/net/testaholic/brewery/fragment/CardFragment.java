...
public class CardFragment extends BaseFragment {
    ...
    public static CardFragment newCardFrontInstance(Ingredients ingredients) {
        return newInstance(ingredients, true);
    }

    public static CardFragment newCardBackInstance(Ingredients ingredients) {
        return newInstance(ingredients, false);
    }

    private static CardFragment newInstance(Ingredients ingredients, boolean cardFront) {
        CardFragment fragment = new CardFragment();
        Bundle bundle = new Bundle();
        bundle.putString(BUNDLE_STRING_WORD, ingredients.getIngredients());
        bundle.putLong(BUNDLE_LONG_CARD_ID, ingredients.getId());
        bundle.putString(BUNDLE_STRING_DEFINITION, ingredients.getDefinition());
