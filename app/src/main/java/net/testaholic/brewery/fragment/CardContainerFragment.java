...
public class CardContainerFragment extends BaseFragment implements View.OnClickListener {
    ...
    private Ingredients entry;

    public static CardContainerFragment newInstance(Ingredients ingredients) {
        CardContainerFragment fragment = new CardContainerFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(ENTRY_ARGUMENT, ingredients);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        entry = (Ingredients) getArguments().getSerializable(ENTRY_ARGUMENT);
    }
