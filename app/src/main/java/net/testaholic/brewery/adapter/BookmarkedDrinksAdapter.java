...
/**
 * Adapter for displaying bookmarked drinks
 */
public class BookmarkedDrinksAdapter extends DrinksAdapter {

    private BookmarkedLessonsTabFragmentPresenter presenter;

    @Inject
    public BookmarkedDrinksAdapter(Activity activity, BookmarkedLessonsTabFragmentPresenter presenter,
                                   Navigator navigator) {
